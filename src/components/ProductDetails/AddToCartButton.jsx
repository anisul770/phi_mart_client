    ...
    <div className='space-y-4'>
      <div className='join'>
        ...
        <input type="number"
          ...
          min={1}
          max={product.stock}
          className='input input-bordered join-item w-16 text-center [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none focus:border-0 focus:'
        />
