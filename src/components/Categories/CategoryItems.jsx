...
const CategoryItems = ({index, category}) => {
  ...
  return (
    <div
      className={`rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 cursor-pointer bg-gradient-to-br ${gradients[index % gradients.length]}`}
    >
      <div className="p-6 flex flex-col h-full">
        <div className="flex justify-between items-center mb-4">
          <div className="w-10 h-10 bg-pink-500 rounded-full flex justify-center items-center text-white font-bold text-xl">
